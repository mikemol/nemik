...
counter 14 · heartbeat 2026-09-26T18:54:37Z · job `02c025ba` · hash `v2:160ea45116511db2`
...
| 11 | W11 | blocked | Ship to luthen: send luthen-observability-1b the full pushed sha carrying W2 (and W3 if landed) so nemik-http rebuilds; live is c9a1cca | luthen-observability | When luthen replies with applied sha, confirm /wake wording on the live endpoint, mark done |
